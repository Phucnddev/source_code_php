        ...
        <div class="form-group">
          ...
          <select name="size[]" class="form-control selectpicker"  multiple data-live-search="true">
              ...
              @foreach($items as $item)
                ...
                // dd($data);
                @endphp
              <option value="36mm"  @if( in_array( "36mmmm",$data ) ) selected @endif>36mm</option>
              <option value="38mm"  @if( in_array( "38mmmm",$data ) ) selected @endif>38mm</option>
              <option value="42mm"  @if( in_array( "42mm",$data ) ) selected @endif>42mm</option>
              <option value="46mm"  @if( in_array( "46mm",$data ) ) selected @endif>46mm</option>
              @endforeach
          </select>
        </div>
        <div class="form-group">
