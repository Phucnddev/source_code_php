				...
				<div class="row">
					<div class="col-lg-6 col-12">
						<div class="about-content">
							...
							@endphp
							<h3>Chào mừng tới <span>ĐỒNG HỒ TREO TƯỜNG</span>.STORE</h3>
					...
					<div class="col-lg-6 col-12">
						<div class="about-img overlay">
							{{-- <div class="button">
								<a href="https://www.youtube.com/watch?v=7TDJxO9B1OA" class="video video-popup mfp-iframe"><i class="fa fa-play"></i></a>
							</div> --}}
